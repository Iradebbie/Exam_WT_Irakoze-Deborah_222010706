...
<div class="page">
    ...
    <a id="create_lecture" class="btn-download">
...
<div class="DataTable" style="display: none;">
    ...
    <table>
        ...
        <tbody>
            <?php include_once("fetchData/getLecture.php"); ?>
        </tbody>
    </table>
</div>
...
<script> 
    $('#updateData').click(function(){
      uni_modal("","lectureForm.php?id=1")
    })
    // Function to fetch and update lecture data
    function updateLectureData() {
        $.ajax({
            url: "fetchData/getLecture.php",
            method: "GET",
            ...
            error: function(xhr, status, error){
                console.log("An error occurred while fetching lecture data.");
            }
        });
    }
    ...
    // Open lectureForm.php when "Add New Lecture" button is clicked
    $('#create_lecture').click(function(){
        uni_modal("","lectureForm.php")
    });
</script>
